...
class CompraForm(forms.ModelForm):
    #mx_date_fields = ("fecha_compra", "fecha_vencimiento")
    ...
    def __init__(self, *args, **kwargs):
        ...
        # aplica el componente MX
        #self.apply_mx_date_fields()

        # muy importante para que el widget type=date formatee bien al editar
        ...
        self.fields['fecha_compra'].input_formats = ['%d/%m/%Y', '%Y-%m-%d']
        self.fields['fecha_vencimiento'].input_formats = ['%d/%m/%Y', '%Y-%m-%d']
...
class EmpresaForm(forms.ModelForm):
    class Meta:
        ...
        exclude = ['empresa','num_empresa','fecha_inicio','fecha_renovacion','factor','activa','directorio',
                   ...
                   'colonia','codigo_postal_expedicion','localidad','municipio','estado','pais','rfc',
                   'regimen_fiscal','num_usuarios']
        widgets = {
