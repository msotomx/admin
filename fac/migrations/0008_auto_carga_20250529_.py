...
def cargar_catalogos(apps, schema_editor):
    ...
    for clave, nombre in regimen_fiscal:
        UsoCfdi.objects.get_or_create(regimen=clave, nombre=descripcion)

class Migration(migrations.Migration):

    dependencies = [
        ('fac', '0007_alter_factura_fecha_creacion_alter_usocfdi_nombre'),  # ultimo archivo en fac/migrations
